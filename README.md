...
The default `TWITCH_CLIENT_SECRET` fallback keeps local setup simple, but production deployments should set distinct high-entropy values for `PUSH_ACTION_TOKEN_SECRET` and `SESSION_TOKEN_ENCRYPTION_KEY`.
